...
<header>
    ...
    <h1 class="text-3xl font-bold tracking-tight text-gray-900">Crear un nuevo registro</h1>
    </div>
    </header>
...
<div class='flex items-center justify-center min-h-screen from-teal-100 via-teal-300 to-teal-500 bg-gradient-to-br'>
    <div class='w-full max-w-lg px-10 py-8 mx-auto bg-white rounded-lg shadow-xl'>
        ...
        @csrf
                ...
                <p class="my-4 opacity-70">Llene todos los campos del nuevo producto a registrasrse</p>
                <hr class="my-6">
